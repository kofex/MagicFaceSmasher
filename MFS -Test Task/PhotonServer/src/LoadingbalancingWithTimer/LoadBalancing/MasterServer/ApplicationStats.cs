namespace Photon.LoadBalancing.MasterServer
{
    ...
    public class ApplicationStats
    {
        ...
        public void OnTimer(EventData eventData)
        {
            foreach (MasterClientPeer peer in subscribers)
            {
                log.Info("MY:::OnTimer peer " + peer.ToString());
                peer.SendEvent(eventData, new SendParameters { Unreliable = true });
            }
